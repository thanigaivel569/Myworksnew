...
class UserDetail extends Component {
    ...
    handledesChange(even) {
        this.state.user.description = even.target.value;
        this.setState({ user: this.state.user });
    }
    ...
    render() {
        ...
        return (
            <div>
                ...
                <h3>Description: <input type="text" placeholder={this.props.user.description} value={this.state.user.description} onChange={this.handledesChange} ></input></h3>
